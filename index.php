<?php 
    ...
    $index_selecting_quiz = $con->query("SELECT quiz_id, display_questions, time_allotted, quiz_name
                                    FROM quizes WHERE set_default=1");
    $index_selecting_quiz_row = $index_selecting_quiz->num_rows;
    $index_selecting_quiz_num = $index_selecting_quiz->fetch_assoc();
    ...
    <head>
        ...
        <script type="text/javascript">
            function submit(){
				...
				var result=x.value.search(/^[1-9]{2}[A-Z]{5}\d{3}$/);
                if(result!=0)
				{
					alert("invaid Roll Number");
				}
				else
				{
        ...
        <div id="main_body" align="center">
            ...
            <form id="myForm" name="onlyForm" action="quiz.php" method="POST">
                <table align="center">
                    <tr>
                        <td align="center">
                            <input type="text" name="rollno" id="usn" placeholder="Enter Your Roll No." autofocus/>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
